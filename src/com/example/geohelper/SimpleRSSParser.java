...
public class SimpleRSSParser extends SimpleFeedParser {

	private SimpleRSSParserCallBack mCallback;
	
    public SimpleRSSParser(String feedUrl, SimpleRSSParserCallBack callback) {
        super(feedUrl);
